...
public void testXxxBtn() {
    try {
        driver.get(BASE_URL);

        // Locate the "Request a Quote" button and click
        WebElement button = driver.findElement(By.xpath("//a[@href='https://xxx.com/contact-us/']//span[contains(text(),'request a Quote')]"));
        ...
        // Verify page title
        String expectedTitle = "A Silicon Valley Proteomics Startup Company: xxx Inc.";
